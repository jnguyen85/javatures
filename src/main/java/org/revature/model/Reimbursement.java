...
public class Reimbursement {
	...
	//employee.getEmployeeId(), amount, filename, is, description, false
	...
	public Reimbursement(int employeeId, double amount, String fileName, InputStream image, String description,
			boolean status) {
		this.employeeId = employeeId;
		this.amount = amount;
		this.fileName = fileName;
